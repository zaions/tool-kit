...
export const ztkPlayWinMessages = (envs: any) => {
  return {
    validation: {
      ...
      maxPlayersShouldBeGreaterOrEqualToMinPlayers: "Max players should be greater or equal to min players to start the game.",
      ...
      amountMustBeGreaterThanOrEqualTo: `Amount must be greater than or equal to ${appServiceFee(envs)?.transfer?.minTransferAmountAllowed}`,
    ...
    request: {
      ...
      topupRequestSend: "Topup request sent successfully. Please wait for review.",
      topupRequestAdded: "Topup request added successfully.",
      topupRequestUpdated: "Topup request updated successfully.",
      topupVerifiedRequestSend: "Verification information sent successfully. Please wait for review.",
      withdrawRequestSend: "Withdraw request sent successfully. Please wait for review."
    },
    ...
    notification: {
      ...
      selectUsersToSendNotification: "Please select users you want to send this notification to."
    },
