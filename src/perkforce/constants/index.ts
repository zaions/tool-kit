...
export const svgIconTypes = ['image/svg', 'image/svg+xml']
...
export const TOOLTIP_TRIGGER_ALL = ['click', 'hover', 'focus', 'contextMenu']

export const POPOVER_TRIGGER = ['click', 'hover']
